...
function createElement3(element, cls) {
	...
	var filename_trimmed = filename;
	var max_len = 50;
	if (filename_trimmed.length > max_len) {
		filename_trimmed = filename_trimmed.substring(0, max_len) + "...";
	}
	div.innerHTML += "<p>" + strToHtml(filename_trimmed) + "</p>";
